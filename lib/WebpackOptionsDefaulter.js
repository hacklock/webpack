...
class WebpackOptionsDefaulter extends OptionsDefaulter {
	constructor() {
		...
		this.set("optimization.removeAvailableModules", "make", options => options.mode === "production");
		this.set("optimization.removeEmptyChunks", "make", options => options.mode === "production");
		this.set("optimization.mergedDuplicateChunks", "make", options => options.mode === "production");
		...
		this.set("optimization.providedExports", "make", options => options.mode === "production");
